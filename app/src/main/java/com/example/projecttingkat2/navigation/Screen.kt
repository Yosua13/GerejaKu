...
sealed class Screen(val route: String) {
    ...
    data object BukuPengguna : Screen("bukuPengguna/{$KEY_ID_BUKU_PENGGUNA}") {
        fun bukuPenggunaId(id: String) = "bukuPengguna/$id"
    }
    ...
    data object BeritaPengguna : Screen("beritaPengguna/{$KEY_ID_BERITA_PENGGUNA}") {
        fun beritaPenggunaId(id: String) = "beritaPengguna/$id"
    }

    data object Profil : Screen("profilScreen")

    data object ChatAI : Screen("chatAIScreen")
}